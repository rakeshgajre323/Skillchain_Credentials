    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full max-w-5xl mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button className="px-8 py-3.5 bg-white text-indigo-600 border border-indigo-600 font-semibold rounded-md hover:bg-indigo-50 transition-all text-base">
            View Credentials
          </button>
        </div>
      </section>
      ...
      <section className="w-full max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Learner Card */}
          <div className="bg-blue-50/80 p-8 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer border border-blue-100">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Learner</h3>
            ...
            <div className="flex justify-center">
               {/* Illustration Placeholder - typically an SVG would go here */}
               <div className="w-full h-32 bg-blue-200/50 rounded-lg flex items-center justify-center text-blue-400">
          ...
          {/* Issuer Card */}
          <div className="bg-green-50/80 p-8 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer border border-green-100">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Issuer</h3>
            <p className="text-slate-600 mb-6 leading-relaxed">
              Issue verifiable skill credentials securely using blockchain. Reduce fraud and streamline the verification process.
            </p>
            <div className="flex justify-center">
               <div className="w-full h-32 bg-green-200/50 rounded-lg flex items-center justify-center text-green-500">
                 <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Company Card */}
           <div className="bg-purple-50/80 p-8 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer border border-purple-100">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Company</h3>
            <p className="text-slate-600 mb-6 leading-relaxed">
              Instantly verify candidate credentials. Save time and resources on background checks with tamper-proof records.
            </p>
            <div className="flex justify-center">
               <div className="w-full h-32 bg-purple-200/50 rounded-lg flex items-center justify-center text-purple-500">
                 <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
