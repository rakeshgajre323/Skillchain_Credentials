...
export const Dashboard: React.FC<DashboardProps> = ({ userRole, userName, onAddCertificate }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full space-y-8">
      ...
      {/* 3. Controls & Filter */}
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white dark:bg-neutral-900 p-2 rounded-2xl border border-slate-200 dark:border-neutral-800 shadow-sm transition-colors">
         ...
         <div className="flex gap-2 w-full md:w-auto p-2 md:p-0">
             {userRole === UserRole.INSTITUTE && (
                <button 
                  ...
                  className="w-full md:w-auto px-6 py-3 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 shadow-lg shadow-blue-200/50 transition-all flex items-center justify-center gap-2"
                >
